...
const DashboardReviews = () => {
  return (
    <div className="border rounded-2xl ">
      <div className="flex gap-5 items-center justify-between bg-blue-50 p-3 px-5 border rounded-t-2xl">
        <div className="flex items-center gap-5">
          <h1 className="text-2xl font-semibold text-[#3633b4]">Reviews</h1>
        </div>
      ...
      <div className="h-[500px] divide-y-2 divide-gray-50 overflow-y-auto">
        {dashboard_data_1?.all_branch_data[0]?.specific_branch_data?.reviews?.map(
          (review_data) => {
            return (
              <div key={review_data?.id} className="grid grid-cols-10 px-3 p-3">
